...
import { setOnlineUsers, userOnline, userOffline } from '@/store/chat/presence.slice';
...
import { typingStarted, typingStopped } from '@/store/chat/typing.slice';

/* =========================
   CALLS
========================= */

import { callIncoming, callEnded } from '@/store/chat/calls.slice';

export function registerSocketListeners(socket: Socket, dispatch: AppDispatch) {
